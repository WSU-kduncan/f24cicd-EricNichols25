...
-  **I utilized the Docker Hub Docs web page to help with proper syntax on the "docker image push" command**. I like to utilize the official docs web pages for Docker Hub. I find them straightforward and relatively helpful. The reason I used these for this project is because the information is helpful and straight forward. The link can be found here:[https://docs.docker.com/reference/cli/docker/image/push/]
